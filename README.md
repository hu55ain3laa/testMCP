...
[![PyPI version](https://img.shields.io/pypi/v/testmcp.svg)](https://pypi.org/project/testmcp/)
...
pip install git+ssh://git@github.com/stainless-sdks/testmcp-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://app.stainless.com/docs/guides/publish), this will become: `pip install --pre testmcp`
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/testmcp-python/tree/main/src/testmcp/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/testmcp-python/tree/main/src/testmcp/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/testmcp-python/issues) with questions, bugs, or suggestions.
