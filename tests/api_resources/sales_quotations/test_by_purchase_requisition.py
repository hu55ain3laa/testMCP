...
class TestByPurchaseRequisition:
    ...
    def test_path_params_print_html(self, client: Testmcp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.sales_quotations.by_purchase_requisition.with_raw_response.print_html(
                id="",
                api_key="apiKey",
            )
...
class TestAsyncByPurchaseRequisition:
    ...
    async def test_path_params_print_html(self, async_client: AsyncTestmcp) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.sales_quotations.by_purchase_requisition.with_raw_response.print_html(
                id="",
                api_key="apiKey",
            )
